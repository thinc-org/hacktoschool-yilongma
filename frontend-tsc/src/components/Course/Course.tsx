        ...
        <div className='max-w-screen min-h-screen bg-[#F6F5F4] flex flex-col items-center md:items-start'>
            <div className='min-w-full flex flex-col md:p-12 md:px-24 lg:p-12 lg:px-48  xl:p-12 xl:px-48'>
                <div className="hidden md:grid grid-cols-[20vw_1fr] rounded-lg bg-[#FFFFFF] h-64 mt-8 mb-8 shadow hover:shadow-lg">
                    <img src={courseData.thumbnail ? `https://pb.jjus.dev/api/files/1dhkvkt2hpbjlid/${courseData.id}/${courseData.thumbnail}` : "https://picsum.photos/200/300"} className='w-full h-full rounded-l-lg min-h-64 max-h-64 min-w-64 max-w-64' />
                ...
                <div className="max-h-[50rem] md:hidden grid grid-rows-[h-64_1fr] rounded-lg bg-[#FFFFFF] h-fit shadow hover:shadow-lg m-8">
                    <img src={courseData.thumbnail ? `https://pb.jjus.dev/api/files/1dhkvkt2hpbjlid/${courseData.id}/${courseData.thumbnail}` : "https://picsum.photos/200/300"} className='w-full h-full object-fill rounded-t-lg min-h-64 max-h-64 min-w-64 max-w-64' />
